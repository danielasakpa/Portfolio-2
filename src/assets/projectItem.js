export const projectItem = [
    {
        ...
        discription: `A simple blog app that lets users write blog entries once they sign up with an account.`,
    ...
    {
        imageUrl: require('./images/chat-app.png'),
        id: "1288213e2189tutrefgerfgf12e12",
        projectNum: "03 Project",
        discription: `Chat app made with socket.io, with user authentication and allows users to create rooms and send messages`,
        liveSite: "/",
