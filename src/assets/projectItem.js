export const projectItem = [
    ...
    },
    {
        ...
        discription: `The purpose of this website was to create a platform for individuals to search for and view properties for sale or rent in their desired location. To begin, I utilized React to build the front end of the website, which 
    ...
    },
    {
        ...
        discription: `FitnessApp is a personal project that aims to provide users with a variety of workouts to choose from. Whether you're looking to improve your strength, cardio, or flexibility, FitnessApp has something for everyone.
    ...
    //     projectNum: "Blog App",
    //     discription: `The purpose of this project is to create a personal blog website where I can share my thoughts and experiences with a wider audience. The website will feature a clean and modern design, with easy navigation for users to find and read my blog posts.
